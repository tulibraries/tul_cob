...
Devise.setup do |config|
  ...
  fetch_remote_idp_metadata =
    if ENV.key?("COB_SAML_FETCH_REMOTE_METADATA")
      ActiveModel::Type::Boolean.new.cast(ENV["COB_SAML_FETCH_REMOTE_METADATA"])
    elsif ENV.key?("FETCH_REMOTE_SAML_METADATA")
      ActiveModel::Type::Boolean.new.cast(ENV["FETCH_REMOTE_SAML_METADATA"])
    else
