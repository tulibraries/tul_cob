...
Rails.application.configure do
  ...
  deploy_namespace = ENV.fetch("APP_DEPLOY_ENV", "prod")
  config.credentials.content_path = Rails.root.join("config/credentials/#{deploy_namespace}.yml.enc")
  config.credentials.key_path = Rails.root.join("config/credentials/#{deploy_namespace}.key")
