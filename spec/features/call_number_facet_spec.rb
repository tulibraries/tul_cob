  ...
  describe "constraints" do
    context "lc outerfacet selected " do
      ...
      it "should add the lc facets constraints" do
        ...
        # TODO: Failing because we are expecting only one constraint in this scenario but ther are 3 constraints on the page.
    ...
    context "Advanced Search Library Of Congress Classification Range search." do
      ...
      it "should add the lc classification constraints" do
        # TODO: This is failing because the constraint is not being added for the page for range searches.
