...
RSpec.describe "search/_bento_results.html.erb", type: :view do
  let(:result_item) do
    double(
      "result",
      failed?: false,
  ...
  before do
    ...
    allow(view).to receive(:render_linked_results).and_return("")
  end
  ...
  it "skips archival collections when flipflop is disabled" do
    ...
    render partial: "search/bento_results", locals: locals
