...
module CatalogHelper
  ...
  def render_purchase_order_button(args)
    ...
    if !current_user
      ...
      link = link_to label, path, class: "btn btn-sm purchase-order", title: "Open a modal form to request a purchase for this item.", target: "_blank", id: "purchase_order_button-#{doc.id}", data: { "blacklight-modal": "trigger" }
