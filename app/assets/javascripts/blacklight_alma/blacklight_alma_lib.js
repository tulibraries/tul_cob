 ...
 */
 ...
 BlacklightAlma.prototype.formatHoldings = function (holdings) {
   ...
   if (available) {
     html = "<dt class='index-label col-md-3' >Available at: </dt><dd class='col-md-7'>" + available + "</dd>";
   }

   if (check) {
   html += "<dt class='index-label col-md-3' >Other Libraries: </dt><dd class='col-md-7'>" + check + "</dd>";
   }
   return html;
 };
