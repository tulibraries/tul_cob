...
module BentoSearch
  ...
  class ResultItem
    ...
    # ContentDM api results attributes
    attr_accessor :cdm_date
    attr_accessor :cdm_collection
    attr_accessor :cdm_id
    attr_accessor :cdm_record_link
    attr_accessor :cdm_thumbnail_link
