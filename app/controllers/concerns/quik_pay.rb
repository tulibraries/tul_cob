...
module QuikPay
  ...
  def quik_pay
    ...
    redirect_to quik_pay_url(params, Rails.configuration.apis.dig(:quik_pay, :secret)), allow_other_host: true
  end
  ...
  def quik_pay_url(params = {}, secret = "")
    ...
    qp_params.merge!(
      ...
      redirectUrl: Rails.configuration.apis.dig(:quik_pay, :redirect_url) || DEFAULT_REDIRECT_URL,
    ...
    qurl = Rails.configuration.apis.dig(:quik_pay, :url) || DEFAULT_QUIK_PAY_URL
