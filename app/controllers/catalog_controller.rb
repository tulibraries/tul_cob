...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.index.constraints_component = LibrarySearch::ConstraintsComponent
    ...
    config.add_facet_field "library_facet",
      ...
      presenter: LibrarySearch::FacetFieldPresenter,
    ...
    config.add_facet_field "collection_ms", label: "Collection Name", limit: true, show: true
    ...
    config.add_search_field("title_starts_with") do |field|
      ...
      field.clause_params = { edismax: { qf: "title_sort" } }
    end
