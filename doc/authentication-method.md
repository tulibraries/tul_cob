...
### Configuration:
The configuration for this method is in `config/initializers/devise.rb` and uses the same `COB_SAML_*` / `COB_SP_*` environment variables as Ruby-SAML.
